...
! function() { "use strict"; var c = {},
        ...
        m = function() { try { return !0 } catch (c) { return !1 } }(); var H = z || {};
    H[M] || (H[M] = {}), H[M].styles || (H[M].styles = {}), H[M].hooks || (H[M].hooks = {}), H[M].shims || (H[M].shims = []); var s = H[M];

    function V(c, v) { var h = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks,
            l = void 0 !== h && h,
            z = Object.keys(v).reduce(function(c, h) { var l = v[h]; return !!l.icon ? c[l.iconName] = l.icon : c[h] = l, c }, {}); "function" != typeof s.hooks.addPack || l ? s.styles[c] = function(z) { for (var c = 1; c < arguments.length; c++) { var a = null != arguments[c] ? arguments[c] : {},
